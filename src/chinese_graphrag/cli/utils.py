...
class ProgressManager:
    ...
    def update_task(self, task_id: str = None, advance: int = 1, description: str = None):
        """更新任務進度。
...
class InteractivePrompt:
    ...
    def input_text(self, message: str, default: str = None, validation: Callable = None) -> str:
        """獲取文字輸入。
...
def show_completion_message(operation: str, duration: float = None, details: str = None):
    """顯示操作完成訊息。
...
__all__ = [
    'ProgressManager', 'InteractivePrompt', 'StatusDisplay',
    'create_status_table', 'create_info_panel',
    'show_welcome_message', 'show_completion_message', 'show_error_message',
    'format_file_size', 'format_duration',
    'progress_manager', 'interactive_prompt', 'status_display', 'console'
]