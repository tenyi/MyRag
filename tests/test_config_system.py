...
class TestConfigLoader:
    ...
    def test_load_config_with_env_vars(self, tmp_path):
        ...
        config_data = {
            ...
            "vector_store": {"type": "lancedb", "uri": "./test_data/lancedb"},
            "model_selection": {
                "default_llm": "test_llm",
                "default_embedding": "test_embedding",
            },
...
class TestEnvironmentManager:
    ...
    def test_get_env_var_with_default(self):
        ...
        value = manager.get_var(
            "NON_EXISTENT_VAR", default="default_value", required=False
        )
...
class TestConfigValidator:
        ...
        config_dict = apply_default_values(
            {
                "models": {
                    ...
                    "test_embedding": {"type": "bge_m3", "model": "BAAI/bge-m3"},
                },
                "model_selection": {
                    "default_llm": "test_llm",
                    "default_embedding": "test_embedding",
    ...
    def test_validate_invalid_chunk_config(self):
        """測試驗證無效的分塊配置。"""
        config_dict = apply_default_values(
            {"chunks": {"size": 100, "overlap": 200}}  # 重疊大於大小
        )
    ...
    def test_validate_missing_default_models(self):
        ...
        config_dict = apply_default_values(
            {
                "models": {
                    "existing_model": {"type": "openai_chat", "model": "gpt-4.1-mini"}
                },
                "model_selection": {
        ...
        assert (
            "non_existent_model" in error_messages
            or "another_non_existent_model" in error_messages
        )
...
class TestConfigIntegration:
    ...
    def test_config_with_validation_warnings(self, tmp_path):
        ...
        config_data = {
            ...
            "chunks": {"size": 5000, "overlap": 200},  # 過大的值，應該產生警告
            "model_selection": {
                "default_llm": "test_llm",
                "default_embedding": "test_embedding",
            },
